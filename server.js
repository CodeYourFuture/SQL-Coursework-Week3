...
//     !newUnit_price > 0 && !typeof newUnit_price == "integer" ? res.status(400).send("The unit price must be number and positive") :

//         pool.query("SELECT * FROM product_availability WHERE prod_id =$1", [newProd_id])
//             .then((result) => {
//                 if (result.rows.length < 0) {
//                     return res
//                         .status(400).json({msg: "The product and The product is not exists!"})
...
//                             if (result.rows.length < 0) {
//                                 return res
//                                     .status(400).json({msg: "The product and The supplier is not exists!"})
//                             }
//                         })
//                         .catch((e) => console.error(e));
//                 } else {
...
//         .catch((e) => console.error(e));
//   }else{
//       res.send({msg:"please make sure you added all fields."})
//   }
// })
...
//             })
//         }else {
//             resp.status(400).send("you have an order I can not delete your profile.");
//         }
//     })
// })
